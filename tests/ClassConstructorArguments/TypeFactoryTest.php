...
use ReflectionClass;
use Sav\Hydrator\ClassConstructorArguments\Type\ArrayMapType;
use Sav\Hydrator\ClassConstructorArguments\Type\ClassType;
use Sav\Hydrator\ClassConstructorArguments\Type\MixedType;
use Sav\Hydrator\ClassConstructorArguments\Type\StringType;
...
final class TypeFactoryTest extends TestCase
{
    ...
    public function testReturnArrayMapType(): void
    {
        ...
        $returnType = $typeFactory->get($arrayVar, self::createStub(ArrayMapInterface::class));
    ...
    public function testThrowReturnArrayMapForNotArray(): void
    {
        ...
        $typeFactory->get($boolVar, self::createStub(ArrayMapInterface::class));
    }
